...
describe('AutoTradingToggle', () => {
  it('disables the confirm button until the exact phrase is typed', () => {
    ...
    const input = screen.getByPlaceholderText('I understand the risks of real money trading');
    ...
    // Type exact phrase
    fireEvent.change(input, { target: { value: 'I understand the risks of real money trading' } });
